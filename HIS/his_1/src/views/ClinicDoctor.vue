          ...
          <el-container direction="horizontal">
            <el-container direction="vertical" style="width: 65%">
              ...
              <el-dialog v-model="addCheckDialog" style="width:70%">
                <el-input placeholder="请输入项目代码" v-model = "queryInfo.query">
                </el-input>
                <el-button style="width: 60px;" icon = "el-icon-search" @click ="getCheckItemList"></el-button>
                  <el-table
                    :data="checkItemData"
                    stripe
                    border
                    ...
                    <el-table-column>
                    <template #default="scope">
                        <el-button  type="primary" @click = "addCheckItem(scope.row.itemCode)">添加</el-button>
                    </template>
                    </el-table-column>
                </el-table>
                    <el-pagination
